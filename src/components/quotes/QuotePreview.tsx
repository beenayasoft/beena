      ...
      <div className="w-full mx-auto" style={{ maxWidth: "210mm", minHeight: "297mm" }}>
        ...
        <div className="p-8 border-b border-neutral-200">
          <div className="flex justify-between">
            ...
            <div className="text-right">
              <div className="text-3xl font-bold text-benaya-900 mb-2">DEVIS</div>
        ...
        <div className="p-8 border-b border-neutral-200">
          <div className="flex justify-between">
            {/* Client Info */}
            <div className="space-y-2">
              <h2 className="text-lg font-semibold text-benaya-900">Client</h2>
        ...
        <div className="p-8 mt-auto">
          ...
          <div className="mb-6">
            <h3 className="text-lg font-semibold text-benaya-900 mb-2">Conditions</h3>
          ...
          <div className="mb-6 border-t border-neutral-200 pt-6">
            <h3 className="text-lg font-semibold text-benaya-900 mb-2">Acceptation du devis</h3>
